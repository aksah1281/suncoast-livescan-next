...
const ContactSection = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      setFormStatus({
        submitted: true,
        error: false,
        message: 'Thank you! Your message has been received. We\'ll contact you shortly.'
      });
  ...
  return (
    <section className="contact-section" id="contact" ref={sectionRef}>
        ...
        <div className="contact-content">
          ...
          >
            <motion.div className="contact-info-card" variants={itemVariants}>
              ...
              <h3>Phone</h3>
              <a href="tel:+18001234567">(813)-618-5227</a>
            ...
            <motion.div className="contact-info-card" variants={itemVariants}>
              ...
              <h3>Email</h3>
              <a href="mailto:info@yourcompany.com">info@suncoastlivescan.net</a>
                ...
                <form onSubmit={handleSubmit} className="contact-form">
                  ...
                  <div className="form-group">
                    ...
                    >
                      ...
                      <option value="identity">Mobile Fingerprinting</option>
      ...
      {/* Improved Map Section with properly formatted location */}
